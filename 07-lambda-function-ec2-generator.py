...
def list_all_instances():
    ...
    for reservation in response['Reservations']:
        for instance in reservation['Instances']:
            ...
            print(my_list)
    return my_list
schedule.every().day.at("03:27").do(list_all_instances)
...
schedule.every().day.at("03:27").do(create_snapshot)
...
schedule.every().day.at("03:27").do(terminate_ec2)
...
schedule.every().day.at("03:27").do(generate_csv_report)
...
schedule.every().day.at("03:27").do(send_email)
...
schedule.every().day.at("03:27").do(send_slack_message)
